...
var rootCmd = &cobra.Command{
	Use:   "my-calc",
	Short: "my-calc can add / subtract / multiply or divide two numbers",
	Long:  `my-calc can add / subtract / multiply or divide two numbers`,
...
func Execute() {
	//	fmt.Println("inside Execute() ---> Before rootCmd.Execute()")
	if err := rootCmd.Execute(); err != nil {
		fmt.Println(err)
		os.Exit(1)
	}
	//	fmt.Println("inside Execute() ---> After rootCmd.Execute()")
}
